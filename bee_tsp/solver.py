...
class BeeTSPSolver:
    ...
    def solve(self, instance_name: str, instance_path: str, seed: int = 0) -> Dict[str, Any]:
        ...
        # DEBUG: Print what config actually says
        print(f"[DEBUG] Initializers config: {self.cfg.get('initializers', 'MISSING')}")
        
        K = self.cfg.get('initializers', {}).get('K', 1)
        ...
        # BUILD INITIAL TOURS
        initial_tours = build_initial_tours(n, dist, candidate_adj, K, init_budget_s, mix)
